...
def _workflow_payload(spec: BotSpec) -> Dict[str, Any]:
    triggers: Dict[str, List[Dict[str, Any]]] = {
        ...
        "pm-tester": [
            ...
            },
            {
                ...
                "title": "Tester Environment Blocker To Engineer",
                "event": "task_completed",
                "target_bot_id": "pm-engineer",
                "condition": "has_result",
                "result_field": "failure_type",
    ...
    notes: Dict[str, str] = {
        ...
        "pm-tester": "Each tester branch routes forward only on pass; implementation failures go back to coder and environment blockers go back to engineer.",
