    ...
    return [
        ...
        BotSpec(
            ...
            system_prompt=(
                ...
                "Any non-pass outcome must still be expressed as a coder-remediable issue for deterministic backward routing.\n"
                "Do not write prose outside the JSON object."
            ),
        ),
        BotSpec(
        ...
        BotSpec(
            ...
            system_prompt=(
                ...
                "Use ui_data_issue or ui_config_issue when the problem still belongs with engineering remediation.\n"
                "Do not write prose outside the JSON object."
            ),
        ),
        BotSpec(
...
def _workflow_payload(spec: BotSpec) -> Dict[str, Any]:
    triggers: Dict[str, List[Dict[str, Any]]] = {
        ...
        "pm-tester": [
            ...
            {
                "id": "tester-env-blocker-engineer",
                "title": "Tester Environment Blocker To Coder",
                "event": "task_completed",
                "target_bot_id": "pm-coder",
                "condition": "has_result",
                "result_field": "failure_type",
        ...
        "pm-security-reviewer": [
            ...
            {
                "id": "security-architecture-coder",
                "title": "Security Architecture Issue To Coder",
                "event": "task_completed",
                "target_bot_id": "pm-coder",
                "condition": "has_result",
                "result_field": "failure_type",
        ...
        "pm-ui-tester": [
            ...
            {
                "id": "ui-env-blocker-engineer",
                "title": "UI Environment Blocker To Engineer",
                "event": "task_completed",
                "target_bot_id": "pm-engineer",
                "condition": "has_result",
                "result_field": "failure_type",
            ...
            {
                "id": "ui-data-back-engineer",
                "title": "UI Data Back To Engineer",
                "event": "task_completed",
                "target_bot_id": "pm-engineer",
                "condition": "has_result",
                "result_field": "failure_type",
            ...
            {
                "id": "ui-config-back-engineer",
                "title": "UI Config Back To Engineer",
                "event": "task_completed",
                "target_bot_id": "pm-engineer",
                "condition": "has_result",
                "result_field": "failure_type",
        ...
        "pm-final-qc": [
            {
                "id": "final-qc-back-pm-incomplete",
                "title": "Final QC Back To PM",
                "event": "task_completed",
            ...
            {
                "id": "final-qc-back-pm-tests",
                "title": "Final QC Test Failure To PM",
                "event": "task_completed",
                "target_bot_id": "pm-orchestrator",
                "condition": "has_result",
                "result_field": "failure_type",
            ...
            {
                "id": "final-qc-back-pm-security",
                "title": "Final QC Security Failure To PM",
                "event": "task_completed",
                "target_bot_id": "pm-orchestrator",
                "condition": "has_result",
                "result_field": "failure_type",
            ...
            {
                "id": "final-qc-back-pm-requirements",
                "title": "Final QC Missing Requirements To PM",
                "event": "task_completed",
                "target_bot_id": "pm-orchestrator",
                "condition": "has_result",
                "result_field": "failure_type",
            ...
            {
                "id": "final-qc-hard-fail-pm",
                "title": "Final QC Hard Failure To PM",
                "event": "task_failed",
                "target_bot_id": "pm-orchestrator",
                "condition": "has_error",
            },
    ...
    notes: Dict[str, str] = {
        ...
        "pm-tester": "Each tester branch routes forward only on pass; all backward remediation goes only to coder.",
        "pm-security-reviewer": "Each security branch routes forward on pass and backward only to coder.",
        "pm-database-engineer": "Validates the joined approved change set and only routes forward to UI testing.",
        "pm-ui-tester": "UI validation routes to final QC on pass or skip, and routes all remediation only to engineer.",
        "pm-final-qc": "Terminal final delivery gate on pass; all failures route back to the PM orchestrator with context.",
    }
    return {
